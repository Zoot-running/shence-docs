...
- `PROJECTS.md` 章程（项目划分、依赖图、定稿决定）
- `REPOS.md` 仓库布局与迁移清单
- `RECOVERY.md` 00:37 会话休眠事故复盘与恢复协议
- `DESIGN/` 架构设计文档
- `VALIDATION/` 三个真实 run 的验证报告归档
- `ADR/` 架构决策记录
- `TESTING.md` 测试方案（双实例拓扑 + 测试金字塔 L0-L4 + 验收门）
- `STATUS.md` 验收状态矩阵（L0/L1/L3 全绿记录）
